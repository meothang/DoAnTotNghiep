                        ...
                        <td align="center" valign="middle" style="background:#ffffff">
                            <table style="width:580px" cellpadding="0" cellspacing="0" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 0px 10px;line-height:17px">
                                            Chào {{ $name}},
                                    ...
                                    <tr style="text-align:center">
                                        <td align: "center">
                                            <h3><span><strong>CHI TIẾT ĐƠN HÀNG</strong></span></h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table align="center" class="list-product" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:600px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="text-transform: uppercase;">{{ $bill -> name}}</td>
                                                        <td align="center">{{ $bill -> qty}} </td>
                                                        <td align="center">{{number_format($bill -> price * $bill -> qty, 0, ',', '.')}} VND </td>
                                                    </tr>
                                                    @endforeach
                                                    <tr>
                                                    <td align="center" colspan="2"><strong>Tổng tiền</strong></td>
                                                    <td align="center"><strong>{{number_format($totalMoney, 0, ',', '.')}} VND </strong></td>
                                                    </tr>
                                    ...
                                    <tr>
                                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 0px 10px;line-height:17px">
                                    ...
                                    <tr>
                                        <td>
                                            <table align="left" valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 0px 10px;line-height:17px">
                                                <tbody>
                                                    <tr>
                                                        <td>
